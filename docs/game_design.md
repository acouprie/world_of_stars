...
| Arbre technologique complet                     | **Implémenté**        | 9 technos initiales, file de recherche, job Sidekiq. Effets non branchés (branche dédiée). Voir `tech_reference.md` et `TECHNO_IMPLEMENTATION.md`. |
